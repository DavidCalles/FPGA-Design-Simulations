...
START:
	-  \ -  \ R1   \ TSA \  -  \ -   \ NEXT \ 100 \ DMUX ;
	-  \ -  \ R2   \ TSA \  -  \ -   \ NEXT \ 200 \ DMUX ;
	-  \ -  \ R3   \ TSA \  -  \ -   \ NEXT \ 300 \ DMUX ;
	-  \ -  \ SP   \ TSA \  -  \ -   \ NEXT \ 255 \ DMUX ; Stack starts at the end
	-  \ -  \ PC   \ TSA \  -  \ -   \ NEXT \ 255 \ DMUX ; Stack starts at the end
WRITE_TO_RAM0:
	-  \ -  \ R1   \ TSA \  -  \ -  \ NEXT \0111010000010b \ DMUX ; R2++
	SP 	\ - \ SP \ DEC \ - \ - \ - \ - \ LDMAR ; Dec SP (move up)	
	R1 	\ - \ -  \TSA\ - \ - \ - \ - \ WRITE ;	 Write contents of R1 to RAM
WRITE_TO_RAM1:
	-  \ -  \ R1   \ TSA \  -  \ -  \ NEXT \1000010000010b \ DMUX ; R2--
	SP 	\ - \ SP \ DEC \ - \ - \ - \ - \ LDMAR ; Dec SP (move up)	
	R1 	\ - \ -  \TSA\ - \ - \ - \ - \ WRITE ;	 Write contents of R1 to RAM
WRITE_TO_RAM2:
	-  \ -  \ R1   \ TSA \  -  \ -  \ NEXT \0110011010011b \ DMUX ; R3+=R2
	SP 	\ - \ SP \ DEC \ - \ - \ - \ - \ LDMAR ; Dec SP (move up)	
	R1 	\ - \ -  \TSA\ - \ - \ - \ - \ WRITE ;	 Write contents of R1 to RAM
...
FETCHING:
	...
	R1 \ -  \ NONE \ TSA \  -  \ INT \ LAD  \ IDLE\ - ; IT Shoulnd be here: goto IDLE

.org (6<<3) ; Rc = Ra+Rb	
	- \ - \ - \ADD\UPZ\INT\LAD\FETCHING\RFMUX ;
.org (7<<3) ; INC(Rx)
	- \ - \ - \INC\UPZ\INT\LAD\FETCHING\RFMUX ;
.org (8<<3) ; DEC(Rx)	
	- \ - \ - \DEC\UPZ\INT\LAD\FETCHING\RFMUX ;
